...
/**
 * Get page panel background based on theme
 */
export const getPagePanelBackground = (theme: ExtendedTheme): string => {
  return theme.name === 'dark'
...
/**
 * Get container styles for a given variant
 */
...
/**
 * Get standardized padding values
 */
export const getStandardPadding = (
  theme: ExtendedTheme,
  size: 'sm' | 'md' | 'lg' = 'md',
) => {
  const sizes = {
...
/**
 * Get standardized gap values
 */
export const getStandardGap = (
  theme: ExtendedTheme,
  size: 'xs' | 'sm' | 'md' | 'lg' = 'md',
) => {
  const sizes = {
...
// ============================================================================
// These provide access to component-specific configuration values
// Previously stored in ComponentTokensDark/Light.ts, now consolidated here

/**
 * Get page body padding configuration
 */
export const getPageBodyPadding = () => ({
  horizontal: 3,
  vertical: 3,
});
 ...
 * Get page body gap
 */
export const getPageBodyGap = () => 2;

/**
 * Get page header padding
 */
export const getPageHeaderPadding = () => 3;
...
/**
 * Container preset - reusable container styling
 */
...
/**
 * Card preset - standard card styling
 */
export const cardPreset = (theme: ExtendedTheme) => css`
  background: ${theme.name === 'dark'
    ? theme.background.secondary
    : theme.background.primary};
  border: 1px solid ${theme.border.color.medium};
