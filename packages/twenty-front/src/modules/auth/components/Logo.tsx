...
import { VoxRing_Icon } from '@/ui/navigation/navigation-drawer/constants/DefaultWorkspaceLogo';
...
export const Logo = ({
  ...
  const defaultPrimaryLogoUrl = `${window.location.origin}${VoxRing_Icon}`;
